...
public class RolController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Language/Bundle").getString("RolCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Language/Bundle").getString("RolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Language/Bundle").getString("RolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
